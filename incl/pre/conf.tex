...
\fancyhead[R]{Group \projectgroup}      % venstre på lige sider, højre på ulige
% \fancyhead[RE]{\leftmark}             % højre på ulige sider
\fancyhead[L]{\leftmark}                % venstre på ulige sider
...
% Instillinger for kode i tekstlinjer
\usepackage{xcolor}
\definecolor{light-gray}{gray}{0.95}
\newcommand{\code}[1]{\colorbox{AAUgrey4}{{\scriptsize \texttt{#1}}}}
