...
\def \projecttitle       {MODSIM Miniprojekt}
\def \projectsubtitle    {Lufthavnskøproblemet}
...
\def \projectnumber      {MODSIM}
\def \projectgroup       {C220 C}
\def \projectauthors     {
...
\include{incl/main/modelling}
\include{incl/main/queue}
\include{incl/main/program}
\include{incl/main/result}
